...
#	get_tree().gjet_root().connect("size_changed",self, "winsize")
	get_tree().get_root().size_changed.connect(winsize)
	load_resolution()
...
#	VisualServer.set_default_clear_color(Color(0,255,0))
#	$CanvasLayer/ToHide.hide()
#	is_transparent = true
#	$CanvasLayer2/BG.hide()
#
